...
. Set username and password to admin / admin on first login : http://study.local:3000
...
. Add "Node Exporter Full[https://grafana.com/grafana/dashboards/1860-node-exporter-full/]" dashboard http://study.local:3000/dashboard/import :
